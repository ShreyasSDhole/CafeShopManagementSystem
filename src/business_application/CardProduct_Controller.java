...
public class CardProduct_Controller implements Initializable
{
    ...
    public void setData(Product_Data prodData) 
    {
    ...
    public void addBtn() 
    {
        Form1Controller mForm = new Form1Controller();
        mForm.customerID();
        ...
        try 
        {
            ...
            else 
            {
                ...
                else 
                {
                    ...
                    prepare.setString(1, String.valueOf(DataOfEmployee.cID));
                    ...
                    prepare.setString(9, DataOfEmployee.username);
